...
/**
 * DataExportResponseTest Class Doc Comment.
 *
 * @author  OpenAPI Generator team
 *
 * @see    https://github.com/openapitools/openapi-generator
 *
 * @coversDefaultClass \MultiFlexi\Api\Model\DataExportResponse
 */
class DataExportResponseTest extends TestCase
{
    /**
     ...
     */
    public function testDataExportResponse(): void
    {
        $testDataExportResponse = new DataExportResponse();
        $namespacedClassname = DataExportResponse::getModelsNamespace().'\\DataExportResponse';
        $this->assertSame('\\'.DataExportResponse::class, $namespacedClassname);
        $this->assertTrue(
    ...
    {
        $schemaArr = DataExportResponse::getOpenApiSchema();
