...
/**
 * DataExportStatusResponseExportsInnerTest Class Doc Comment.
 *
 * @author  OpenAPI Generator team
 *
 * @see    https://github.com/openapitools/openapi-generator
 *
 * @coversDefaultClass \MultiFlexi\Api\Model\DataExportStatusResponseExportsInner
 */
class DataExportStatusResponseExportsInnerTest extends TestCase
{
    /**
     ...
     */
    public function testDataExportStatusResponseExportsInner(): void
    {
        $testDataExportStatusResponseExportsInner = new DataExportStatusResponseExportsInner();
        $namespacedClassname = DataExportStatusResponseExportsInner::getModelsNamespace().'\\DataExportStatusResponseExportsInner';
        $this->assertSame('\\'.DataExportStatusResponseExportsInner::class, $namespacedClassname);
        $this->assertTrue(
    ...
    {
        $schemaArr = DataExportStatusResponseExportsInner::getOpenApiSchema();
