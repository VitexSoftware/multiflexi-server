...
/**
 * LogoutPostRequestTest Class Doc Comment.
 *
 * @author  OpenAPI Generator team
 *
 * @see    https://github.com/openapitools/openapi-generator
 *
 * @coversDefaultClass \MultiFlexi\Api\Model\LogoutPostRequest
 */
class LogoutPostRequestTest extends TestCase
{
    /**
    ...
    {
        $testLogoutPostRequest = new LogoutPostRequest();
        $namespacedClassname = LogoutPostRequest::getModelsNamespace().'\\LogoutPostRequest';
        $this->assertSame('\\'.LogoutPostRequest::class, $namespacedClassname);
        $this->assertTrue(
    ...
    {
        $schemaArr = LogoutPostRequest::getOpenApiSchema();
