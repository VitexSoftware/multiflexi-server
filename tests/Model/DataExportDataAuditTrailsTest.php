...
/**
 * DataExportDataAuditTrailsTest Class Doc Comment.
 *
 * @author  OpenAPI Generator team
 *
 * @see    https://github.com/openapitools/openapi-generator
 *
 * @coversDefaultClass \MultiFlexi\Api\Model\DataExportDataAuditTrails
 */
class DataExportDataAuditTrailsTest extends TestCase
{
    /**
     ...
     */
    public function testDataExportDataAuditTrails(): void
    {
        $testDataExportDataAuditTrails = new DataExportDataAuditTrails();
        $namespacedClassname = DataExportDataAuditTrails::getModelsNamespace().'\\DataExportDataAuditTrails';
        $this->assertSame('\\'.DataExportDataAuditTrails::class, $namespacedClassname);
        $this->assertTrue(
    ...
    /**
     * Test attribute "dataExportRequests".
     */
    ...
    {
        $schemaArr = DataExportDataAuditTrails::getOpenApiSchema();
