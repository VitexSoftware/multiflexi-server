...
/**
 * DataExportDataConsentRecordsConsentAuditTrailInnerTest Class Doc Comment.
 *
 * @author  OpenAPI Generator team
 *
 * @see    https://github.com/openapitools/openapi-generator
 *
 * @coversDefaultClass \MultiFlexi\Api\Model\DataExportDataConsentRecordsConsentAuditTrailInner
 */
class DataExportDataConsentRecordsConsentAuditTrailInnerTest extends TestCase
{
    /**
     ...
     */
    public function testDataExportDataConsentRecordsConsentAuditTrailInner(): void
    {
        $testDataExportDataConsentRecordsConsentAuditTrailInner = new DataExportDataConsentRecordsConsentAuditTrailInner();
        $namespacedClassname = DataExportDataConsentRecordsConsentAuditTrailInner::getModelsNamespace().'\\DataExportDataConsentRecordsConsentAuditTrailInner';
        $this->assertSame('\\'.DataExportDataConsentRecordsConsentAuditTrailInner::class, $namespacedClassname);
        $this->assertTrue(
    ...
    {
        $schemaArr = DataExportDataConsentRecordsConsentAuditTrailInner::getOpenApiSchema();
