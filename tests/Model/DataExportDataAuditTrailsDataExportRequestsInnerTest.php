...
/**
 * DataExportDataAuditTrailsDataExportRequestsInnerTest Class Doc Comment.
 *
 * @author  OpenAPI Generator team
 *
 * @see    https://github.com/openapitools/openapi-generator
 *
 * @coversDefaultClass \MultiFlexi\Api\Model\DataExportDataAuditTrailsDataExportRequestsInner
 */
class DataExportDataAuditTrailsDataExportRequestsInnerTest extends TestCase
{
    /**
     ...
     */
    public function testDataExportDataAuditTrailsDataExportRequestsInner(): void
    {
        $testDataExportDataAuditTrailsDataExportRequestsInner = new DataExportDataAuditTrailsDataExportRequestsInner();
        $namespacedClassname = DataExportDataAuditTrailsDataExportRequestsInner::getModelsNamespace().'\\DataExportDataAuditTrailsDataExportRequestsInner';
        $this->assertSame('\\'.DataExportDataAuditTrailsDataExportRequestsInner::class, $namespacedClassname);
        $this->assertTrue(
    ...
    {
        $schemaArr = DataExportDataAuditTrailsDataExportRequestsInner::getOpenApiSchema();
