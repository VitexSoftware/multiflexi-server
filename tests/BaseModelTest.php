 ...
 *
 * @coversDefaultClass \MultiFlexi\Api\BaseModel
 */
class BaseModelTest extends TestCase
{
     ...
     */
    public function testConstructorAndDefaultData($className, $expectedJson): void
    {
        $item = new $className();
        $this->assertEquals($expectedJson, json_encode($item->getData()));
    }

    public static function provideClassesAndDefaultData(): iterable
    {
        return [
     ...
     * @param mixed $className
     */
    public function testConstructorWithInvalidTypes($className): void
    {
     ...
     * @param mixed $data
     */
    public function testCreateFromData($modelClass, $data): void
    {
    ...
    public static function provideCreateFromDataArguments(): iterable
    {
        return [
            'CatRefTestClass' => [
     ...
     * @param mixed $className
     */
    public function testSetDataScalar($className, array $setDataValues, array $expectedDataValues): void
    {
        $item = new $className();
    ...
    public static function provideScalarModels(): iterable
    {
        return [
            'boolean model' => [
     ...
     * @covers ::setData
     */
    public function testSetDataOfArray(): void
    {
     ...
     * @param mixed $data
     */
    public function testSetDataOfArrayWithInvalidData($className, $data): void
    {
        $this->expectException(\InvalidArgumentException::class);
        $item = new $className();
        $item->setData($data);
    ...
    public static function provideInvalidDataForArrayModel(): iterable
    {
        $obj = new \StdClass();
        $obj->foo = 'bar';
        $obj->baz = 'baf';
     ...
     * @covers ::setData
     */
    public function testSetDataOfObject(): void
    {
     ...
     * @covers ::getData
     */
    public function testGetDataOfObject(): void
    {
        ...
        $this->assertFalse($data->declawed);
    }
    ...
    public function testSetter(): void
    {
        ...
        $this->assertFalse($item->declawed);
    }
     ...
     * @param mixed $className
     */
    public function testSetterOfScalarAndArray($className): void
    {
        $this->expectException(\InvalidArgumentException::class);
        $item = new $className();
        $item->foo = 'bar';
    ...
    public static function provideScalarsAndArray(): iterable
    {
        return [
     ...
     * @param mixed $className
     */
    public function testGetterOfScalarAndArray($className): void
    {
        $this->expectException(\InvalidArgumentException::class);
        $item = new $className();
        $bar = $item->foo;
     ...
     * @covers ::__set
     */
    public function testSetterAndGetterOfBasicObject(): void
    {
     ...
     * @param mixed $expectedJson
     */
    public function testJsonSerialize($className, $data, $expectedJson): void
    {
        $item = $className::createFromData($data);
        $this->assertEquals($expectedJson, json_encode($item));
    }

    public static function provideJsonSerializeArguments(): iterable
    {
        return [
     ...
     * @param mixed $classname
     */
    public function testGetModelsNamespace($classname): void
    {
