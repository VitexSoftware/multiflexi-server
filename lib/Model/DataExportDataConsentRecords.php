 ...
 */
class DataExportDataConsentRecords extends BaseModel
{
    /**
    ...
    protected const MODEL_SCHEMA = <<<'SCHEMA'
{
  ...
  "properties" : {
    "consent_records" : {
      "type" : "array",
      "items" : {
        "$ref" : "#/components/schemas/DataExportData_consent_records_consent_records_inner"
      }
    },
    "consent_audit_trail" : {
      "type" : "array",
      "items" : {
        "$ref" : "#/components/schemas/DataExportData_consent_records_consent_audit_trail_inner"
      }
    }
  }
}
