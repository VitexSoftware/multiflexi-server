 ...
 */
class DataExportDataSessionHistory extends BaseModel
{
    /**
    ...
    protected const MODEL_SCHEMA = <<<'SCHEMA'
{
  ...
  "properties" : {
    "note" : {
      "type" : "string",
      "example" : "Session history is not permanently stored in the database"
    },
    "current_session_info" : {
      "$ref" : "#/components/schemas/DataExportData_session_history_current_session_info"
    }
  }
}
SCHEMA;
