 ...
 */
class DataExportDataAuditTrailsDataExportRequestsInner extends BaseModel
{
    /**
    ...
    protected const MODEL_SCHEMA = <<<'SCHEMA'
{
  ...
  "properties" : {
    "message" : {
      "type" : "string",
      "example" : "User requested data export in json format from IP 192.168.1.100"
    },
    "timestamp" : {
      "type" : "string",
      "format" : "date-time",
      "example" : "2024-10-20T16:15:00Z"
    }
  }
}
SCHEMA;
