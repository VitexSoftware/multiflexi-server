    ...
    public function __invoke(\DI\ContainerBuilder $containerBuilder): void
    {
        $containerBuilder->addDefinitions([
            ...
            \OpenAPIServer\Mock\OpenApiDataMockerInterface::class => \DI\create(\OpenAPIServer\Mock\OpenApiDataMocker::class)
                ->method('setModelsNamespace', 'MultiFlexi\Api\Model\\'),
            ...
            // Monolog Logger
            \Psr\Log\LoggerInterface::class => \DI\factory(static function (string $mode, string $name, string $path, $level, array $options = []) {
