...
abstract class AbstractTaskApi
{
     ...
     * Notes: Returns a single task together with its job attempt history.
     ...
     * GET listTasks
     * Summary: List Tasks
     * Notes: Returns a list of tasks, optionally filtered by state or runtemplate_id.
     * Output-Formats: [application/json].
     *
     * @param ServerRequestInterface $request  Request
     * @param ResponseInterface      $response Response
    ...
    public function listTasks(
        ...
        $state = (\array_key_exists('state', $queryParams)) ? $queryParams['state'] : null;
