...
abstract class AbstractDefaultApi
{
     ...
     * Notes: Invalidační aktuální uživatelskou session nebo token (OAuth2, JWT, případně session cookie).
     *
     * @param ServerRequestInterface $request  Request
     * @param ResponseInterface      $response Response
     *
    ...
    public function logoutPost(
        ...
        $message = 'How about implementing logoutPost as a POST method in MultiFlexi\\Api\\Server\\DefaultApi class?';
